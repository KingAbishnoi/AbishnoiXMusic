...
from AbishnoiXMusic.utils.database import get_authuser_names, get_cmode
from AbishnoiXMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from AbishnoiXMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await AbishnoiX.stop_stream(message.chat.id)
    except:
        pass
